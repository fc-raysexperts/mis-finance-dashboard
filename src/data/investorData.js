...
const DEFAULTS = {
  ...
  epcRevenueRecognition: [
    { client: 'Uttam Strips', projectId: '2346113000008468113', park: 'Lunkaransar', dcCapacity: 26.2, bessCapacity: 11.29, totalCost: 87.45, commissioningDate: '07-Jul-2026' },
    { client: 'ASK', projectId: '2346113000012388249', park: 'Kolayat', dcCapacity: 11.55, bessCapacity: 4.07, totalCost: 35.28, commissioningDate: '21-Aug-2026' },
    { client: 'Mangalam', projectId: '2346113000014392229', park: 'Panchu', dcCapacity: 1.72, bessCapacity: null, totalCost: 5.17, commissioningDate: '06-Aug-2026' },
    ...
    { client: 'MEC Bearings', projectId: '2346113000014425669', park: 'Panchu', dcCapacity: 1.0, bessCapacity: null, totalCost: 3.0, commissioningDate: '13-Aug-2026' },
    ...
    { client: 'Inox Air', projectId: '2346113000014589808', park: 'Dechu', dcCapacity: 12.0, bessCapacity: 11.29, totalCost: 28.16, commissioningDate: '25-Jul-2026' },
    { client: 'Kamdhenu Limited', projectId: '2346113000014787646', park: 'Dechu', dcCapacity: 5.0, bessCapacity: null, totalCost: 14.55, commissioningDate: '02-Jun-2026' },
    { client: 'Lords Chloro Phase 2', projectId: '2346113000015083217', park: 'Lunkaransar', dcCapacity: 21.0, bessCapacity: 1.45, totalCost: 29.4, commissioningDate: '02-Aug-2026' },
    { client: 'Wonder Cement Phase 2', projectId: '2346113000015444806', park: 'Dechu', dcCapacity: 39.6, bessCapacity: 2.93, totalCost: 113.76, commissioningDate: '29-Jul-2026' },
    ...
    { client: 'Raksha Bars', projectId: '2346113000024486636', park: 'Dechu', dcCapacity: 7.35, bessCapacity: null, totalCost: 21.39, commissioningDate: '04-Jun-2026' },
    { client: 'JECRC', projectId: '2346113000024545225', park: 'Dechu', dcCapacity: 7.35, bessCapacity: null, totalCost: 21.98, commissioningDate: '' },
    { client: 'Jagdamba', projectId: '2346113000024545231', park: 'Dechu', dcCapacity: 0.81, bessCapacity: null, totalCost: 2.36, commissioningDate: '02-Jul-2026' },
    { client: 'Alliance Poly sacks', projectId: '2346113000024545243', park: 'Dechu', dcCapacity: 3.2, bessCapacity: null, totalCost: 10.21, commissioningDate: '' },
    { client: 'Siddharth Polysacks', projectId: '2346113000024545237', park: 'Dechu', dcCapacity: 1.25, bessCapacity: null, totalCost: 3.99, commissioningDate: '' },
    ...
    { client: 'Ravi Surya Spa', projectId: '2346113000025824143', park: 'Lunkaransar', dcCapacity: 2.08, bessCapacity: null, totalCost: 6.14, commissioningDate: '' },
